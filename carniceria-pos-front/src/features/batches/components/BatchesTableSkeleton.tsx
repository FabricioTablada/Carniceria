...
interface BatchesTableSkeletonProps {
   ...
   * `InventoryTableSkeleton.tsx`/`SuppliersTableSkeleton.tsx`. */
  bare?: boolean
}

/**
 * features/batches/components/BatchesTableSkeleton.tsx
 * -----------------------------------------------------------------------------
 * Mismo patron que `InventoryWasteTableSkeleton.tsx`. Forma propia: Código,
 * Producto, Sucursal, Cantidad disponible, Vencimiento, Estado, Acciones.
 */
export function BatchesTableSkeleton({ rows = 8, bare = false }: BatchesTableSkeletonProps) {
  return (
